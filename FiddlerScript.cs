...
class Handlers
{
	...
	*/
	...
	static var _static_body_req = "hcc_reqBodyPath= ";	  //固定值，解析请求body
	static var _static_body_res = "hcc_resBodyPath= ";	  //固定值，解析返回body
	...
	static var _lockSlim 		 = new ReaderWriterLockSlim();
	/////////////////////////自定义字符串 ///////////////////////////     
